...
${components[1] ? `${(0, import_chunks.v)(components[0] || import_chunks.m, "svelte:component").$$render($$result, { data: data_0, errors }, {}, {
    default: () => {
      return `${components[2] ? `${(0, import_chunks.v)(components[1] || import_chunks.m, "svelte:component").$$render($$result, { data: data_1, errors }, {}, {
        default: () => {
          return `${(0, import_chunks.v)(components[2] || import_chunks.m, "svelte:component").$$render($$result, { data: data_2, errors }, {}, {})}`;
        }
