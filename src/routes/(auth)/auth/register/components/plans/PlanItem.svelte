...
<div class="plans__item {className}" class:active={current === currentPlan}>
  ...
  >
    <div class="column">
      ...
      <div class="item__head__name">Select {planName}</div>
    </div>
    <div class="column">
      <div
  ...
  <div class="item__body">
    <div>
      <div class="item__top">
        <div class="item__top__head">You contribute to {planName}</div>
